...
ComaModel::ComaModel( const simulation_setup::ComaPolyDataset& polyDataset,
    ...
    cachedFinalDensity_( 0.0 ), cachedDensityCorrectionMultipliers_( Eigen::VectorXd::Ones( 1 ) ),
    cachedDensityCorrectionArcIndex_( 0 ), cachedFinalTemperature_( 0.0 ), interpolationPoint2D_( 2 ), interpolationPoint1D_( 1 ),
    ...
    specificGasConstant_( physical_constants::MOLAR_GAS_CONSTANT / molecularWeight ), densityCorrectionHarmonicDegree_( 0 ),
    densityCorrectionParameters_( Eigen::VectorXd::Zero( 1 ) ), useArcWiseDensityCorrection_( false ),
